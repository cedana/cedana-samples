/**
  ...
  @brief A simple CUDA measure to measure computational throughput using CUDA events

  This program simply exercises SAXPY: Single-Precision A*X Plus Y on a large number of elements.
  Typically, doing this operation repeatedly will saturate the memory bandwidth of the GPU, giving
  us effective bandwidth, which we call throughput. This effective bandwidth will always be less
  than the advertised theoretical bandwidth of the GPU.
